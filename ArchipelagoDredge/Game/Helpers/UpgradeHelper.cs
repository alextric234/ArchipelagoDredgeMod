...
public static class UpgradeHelper
{
    ...
    {
        [HullTier.Tier1] = new EquipmentTierMapping
            {EngineTier = 0, FishingRodTier = 0, NetTier = 0, LightTier = 0, StorageTier = 0},
        [HullTier.Tier2] = new EquipmentTierMapping
            {EngineTier = 1, FishingRodTier = 1, NetTier = 1, LightTier = 1, StorageTier = 0},
        [HullTier.Tier3] = new EquipmentTierMapping
            {EngineTier = 2, FishingRodTier = 2, NetTier = 1, LightTier = 1, StorageTier = 2},
        [HullTier.Tier4] = new EquipmentTierMapping
            {EngineTier = 3, FishingRodTier = 3, NetTier = 3, LightTier = 3, StorageTier = 3},
        [HullTier.Tier5] = new EquipmentTierMapping
            {EngineTier = 4, FishingRodTier = 4, NetTier = 3, LightTier = 4, StorageTier = 4}
    };
    ...
    public static void UpgradeItem(string itemName)
    {
        switch (itemName)
        {
            ...
            case "Progressive Engine":
                _upgradeState.EngineTier = Math.Min(_upgradeState.EngineTier + 1,
                    HullToEquipmentMapping[HullTier.Tier5].EngineTier);
                ApplyUpgradesToGame();
                break;
            case "Progressive Fishing":
                _upgradeState.FishingRodTier = Math.Min(_upgradeState.FishingRodTier + 1,
                    HullToEquipmentMapping[HullTier.Tier5].FishingRodTier);
                ApplyUpgradesToGame();
                break;
            case "Progressive Net":
                _upgradeState.NetTier =
                    Math.Min(_upgradeState.NetTier + 1, HullToEquipmentMapping[HullTier.Tier5].NetTier);
                ApplyUpgradesToGame();
                break;
            case "Progressive Light":
                _upgradeState.LightTier = Math.Min(_upgradeState.LightTier + 1,
                    HullToEquipmentMapping[HullTier.Tier5].LightTier);
                ApplyUpgradesToGame();
                break;
            case "Progressive Storage":
                _upgradeState.StorageTier = Math.Min(_upgradeState.StorageTier + 1,
                    HullToEquipmentMapping[HullTier.Tier5].StorageTier);
                ApplyUpgradesToGame();
                break;
        }
    }
